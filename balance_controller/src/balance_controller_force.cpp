...
bool BalanceControllerForce::init(hardware_interface::RobotHW* robot_hw,
  ...
  */
  ...
  pid_y_.initPid(0.0023/*p*/, 0.0/*i*/, 0.0/*d*/, 0.3/*i_max*/, -0.3/*i_min*/, true/*antiwindup*/);
  pid_x_init_.initPid(5.0/*p*/, 2.0/*i*/, 0.0/*d*/, 0.8/*i_max*/, -0.8/*i_min*/, true/*antiwindup*/);
  pid_y_init_.initPid(5.0/*p*/, 2.0/*i*/, 0.0/*d*/, 0.8/*i_max*/, -0.8/*i_min*/, true/*antiwindup*/);
...
void BalanceControllerForce::update(const ros::Time& /*time*/, const ros::Duration& period) {
  ...
  if (control_position_ && position_initialized_)
  {
    ...
    if ((x_current < x_max_) && (x_current > x_min_))
    {
      ...
      double effort_y = pid_y_.computeCommand(y_current - y_middle_, time - last_time_);
      if (effort_x < 0)
      {
        effort_x *= 1.175;
      }
  ...
  {
    ros::Time time = ros::Time::now();
    double effort_x = pid_x_init_.computeCommand(current_pose_[6] - 0.05, time - last_time_);
